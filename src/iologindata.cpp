...
bool IOLoginData::loadPlayer(Player* player, DBResult_ptr result)
{
	...
	player->defaultOutfit.type = result->getNumber<uint16_t>("looktype");
	player->defaultOutfit.head = result->getNumber<uint16_t>("lookhead");
	player->defaultOutfit.body = result->getNumber<uint16_t>("lookbody");
	player->defaultOutfit.legs = result->getNumber<uint16_t>("looklegs");
	player->defaultOutfit.feet = result->getNumber<uint16_t>("lookfeet");
	player->defaultOutfit.addons = result->getNumber<uint16_t>("lookaddons");
	player->defaultOutfit.mount = result->getNumber<uint16_t>("lookmount");
	player->defaultOutfit.mountHead = result->getNumber<uint16_t>("lookmounthead");
	player->defaultOutfit.mountBody = result->getNumber<uint16_t>("lookmountbody");
	player->defaultOutfit.mountLegs = result->getNumber<uint16_t>("lookmountlegs");
	player->defaultOutfit.mountFeet = result->getNumber<uint16_t>("lookmountfeet");
...
bool IOLoginData::savePlayer(Player* player)
{
	...
	query << "`lookbody` = " << static_cast<uint32_t>(player->defaultOutfit.body) << ',';
	query << "`lookfeet` = " << static_cast<uint32_t>(player->defaultOutfit.feet) << ',';
	query << "`lookhead` = " << static_cast<uint32_t>(player->defaultOutfit.head) << ',';
	query << "`looklegs` = " << static_cast<uint32_t>(player->defaultOutfit.legs) << ',';
	query << "`looktype` = " << player->defaultOutfit.type << ',';
	query << "`lookaddons` = " << static_cast<uint32_t>(player->defaultOutfit.addons) << ',';
	query << "`lookmount` = " << player->defaultOutfit.mount << ',';
	query << "`lookmounthead` = " << static_cast<uint32_t>(player->defaultOutfit.mountHead) << ',';
	query << "`lookmountbody` = " << static_cast<uint32_t>(player->defaultOutfit.mountBody) << ',';
	query << "`lookmountlegs` = " << static_cast<uint32_t>(player->defaultOutfit.mountLegs) << ',';
	query << "`lookmountfeet` = " << static_cast<uint32_t>(player->defaultOutfit.mountFeet) << ',';
